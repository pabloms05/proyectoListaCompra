            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('listas.update', $lista) }}" method="POST" class="max-w-4xl" x-data="{
                        // 1. Cargar las categorías y productos maestros desde PHP
                        ...
                        categoriaActual: '', // ID de la categoría seleccionada
                        productosFiltrados: [], // Productos de la categoría seleccionada
                        productoAAnadirId: '', // ID del producto seleccionado para añadir
                        productoAAnadirCantidad: 1, // Cantidad para el nuevo producto
                        ...
                        addProducto() {
                            ...
                            // Opcional: Resetear los campos después de añadir
                        ...
                        @method('PUT') <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $lista->name) }}" required class="w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                        </div>
                        <div class="mb-6">
                            <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">DESCRIPCION</label>
                            <textarea id="description" name="description" rows="4" class="w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">{{ old('description', $lista->description) }}</textarea>
                        </div>
                        ...
                        <div class="p-4 mb-8 border rounded-lg dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                            ...
                            <div x-data="{
                                ...
                                addNuevoProducto() {
                                    ...
                                    // Añadir el producto nuevo a la lista con un ID temporal único
                                    ...
                                    <div class="flex items-center space-x-4 p-3 border rounded-md dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm">
                                        ...
                                        <template x-if="producto.es_nuevo">
                                            <div>
                                                ...
                                                <input type="hidden" :name="'nuevos_productos[' + getProductosNuevos().indexOf(producto) + '][categoria_id]'" :value="producto.categoria_id">
                                            </div>
                                        </template>
