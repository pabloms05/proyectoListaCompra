...
Route::middleware('auth')->group(function () {
    ...
    // Ruta API para obtener listas compartidas (JSON)
    Route::get('/api/listas/compartidas', [CompartirListaController::class, 'compartidasConmigo'])
        ->name('api.listas.compartidas');
